    ...
    return (
        <>
            ...
            >
                <p>
                    {' '}
                    Are you sure you want to remove these drivers? This action
                    can&apos;t be undo.{' '}
                </p>
            </ConfirmDialog>
            <Dialog
            ...
            >
                ...
                <p>Send message to the following drivers</p>
                <Avatar.Group
                    chained
                ...
                >
                    {selectedDriver.map((driver) => (
                        <Tooltip key={driver.id} title={driver.name}>
                            <Avatar size={30} src={driver.img} alt="" />
                        </Tooltip>
                    ))}
                </Avatar.Group>
                <div className="my-4">
...
export default DriverListSelected
