...
const ConsignorListSelected = () => {
    ...
    const handleDeleteSelected = () => {
        ...
        console.log('Delete selected consignors:', selectedConsignor)
    }
            ...
            <div className="flex items-center justify-between max-w-7xl mx-auto">
                <div className="flex items-center gap-4">
                    <span className="text-sm text-gray-600 dark:text-gray-400">
                        {selectedConsignor.length} consignor(s) selected
                    </span>
                    <Button
                        size="sm"
                        variant="plain"
...
export default ConsignorListSelected
